...
export default function Footer({ onOpenBooking, onNavigate }) {
  return (
    <footer style={{ backgroundColor: '#F8FAFC', borderTop: '1px solid #E2E8F0', paddingTop: '80px', paddingBottom: '40px' }}>
      <div className="container">
        ...
        >
          ...
          {/* Col 4: Socials & Certifications */}
          <div style={{ borderLeft: '1px solid #E2E8F0', paddingLeft: '32px' }} className="cert-col">
            ...
            <div>
              <div style={{ fontSize: '13px', fontWeight: '700', color: '#2264F6', letterSpacing: '0.04em', textTransform: 'uppercase', marginBottom: '14px' }}>
                Certifications
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flexWrap: 'wrap' }}>
                <img
                  src="/images/certified-corp-pixfort-logo-dark-1.webp"
                  alt="Certified B Corporation"
                  style={{ height: '48px', width: 'auto', objectFit: 'contain' }}
                />
                <img
                  src="/images/google-partner-pixfort-logo-1.webp"
                  alt="Google Partner"
