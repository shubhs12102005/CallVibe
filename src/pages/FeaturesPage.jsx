    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#FFFFFF' }}>
      ...
      >
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          {/* Marquee snippet */}
          <div style={{ marginTop: '50px', borderTop: '1px solid rgba(255, 255, 255, 0.12)', paddingTop: '32px' }}>
            <div style={{ fontSize: '13px', color: 'rgba(255, 255, 255, 0.65)', marginBottom: '16px', letterSpacing: '0.04em', textTransform: 'uppercase' }}>
              Seamless integrations with your favorite tools
            </div>
            <div className="marquee-container">
              <div className="marquee-track">
                {[...partners, ...partners].map((src, i) => (
                  <div key={i} style={{ minWidth: '130px', height: '44px', display: 'flex', alignItems: 'center' }}>
                    <img src={src} alt="partner" style={{ maxHeight: '32px', filter: 'brightness(0) invert(1)', opacity: 0.8 }} />
                  </div>
                ))}
              </div>
            </div>
